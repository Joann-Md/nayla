...
global.mods = ['6285729933146'] // Want some help?
global.prems = JSON.parse(fs.readFileSync('./src/premium.json')) // Premium user has unlimited limit
global.DeveloperMode = 'false' // true or false
global.linkGC = ['https://chat.whatsapp.com/I3QgWhYRLrYFtcRYxeUzTK']
global.packname = 'Joann-B0TZ'
global.author = 'Joann'
global.multiplier = 36 // The higher, The harder levelup
global.sessionName = 'joann' // The Session name behind the .json example is nayla.json
global.mesreport = 50
global.botname = 'JOANN-BOTZ'
